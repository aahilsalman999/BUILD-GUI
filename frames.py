...
frame_1.grid(row = 0, column = 0, padx = 20, pady = 10, sticky = "nsew")
...
frame_2.grid(row = 0, column = 1, padx = 20, pady = 10, sticky = "nsew")
...
frame_3.grid(row = 1, column = 0, padx = 20, pady = 10, sticky = "nsew")
...
frame_4.grid(row = 1, column = 1, padx = 20, pady = 10, sticky = "nsew")
