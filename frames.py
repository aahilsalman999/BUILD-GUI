...
but = Button(frame_1, text = "Hello", width = 30, height = 20)
but.pack(padx = 20, pady = 50)
...
but = Button(frame_2, text = "Hello", width = 30, height = 20)
but.pack(padx = 20, pady = 50)
...
but = Button(frame_3, text = "Hello", width = 30, height = 20)
but.pack(padx = 20, pady = 50)
...
but = Button(frame_4, text = "Hello", width = 30, height = 20)
but.pack(padx = 20, pady = 50)
